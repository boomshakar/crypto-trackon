...
import WatchlistTable from '../components/WatchlistTable/WatchistTable.jsx';
...
const Home = () => {
  ...
  return (
    <div>
        ...
        <DashboardLead>
          <div>
            ...
            <CustomTag
              ...
              marginR="10px"
              borderActive={dataTab.id === 'watchlist'}
              onClick={() => setDataTab({ id: 'watchlist' })}
            />
            <CustomTag
              title="All Crypto"
      ...
      <CoinTableWrapper>
        {dataTab.id === 'watchlist' ? <WatchlistTable /> : <DataTable dataTBL={cryptodataTBL} />}
      </CoinTableWrapper>
    </div>
  );
};
