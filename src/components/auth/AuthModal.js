        ...
        <Fade in={open}>
          <Box sx={style}>
            <TabContext value={value}>
              ...
              <TabPanel value="1">
                <Login handleClose={handleClose} googleAuthProvider={googleAuthProvider} />
              ...
              <TabPanel value="2">
                <Signup handleClose={handleClose} googleAuthProvider={googleAuthProvider} />
                <Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                  <div>-OR-</div>
                  <Button size="large" onClick={handleGoogleSubmit} variant="outlined">
                    {googleLoginLoad ? (
